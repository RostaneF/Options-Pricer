...
int main() {
...

    {
        ...
        for (auto& opt_ptr : opt_ptrs) {
            ...
            std::cout << "price: " << (*pricer)() << std::endl << std::endl; // Pour les affichages des prix ce ne sont pas les mêmes que precedemment parcequ'on utilise pas les mêmes valeurs de U D R.
            // Pour obtenir les mêmes valeurs, il faut fixer arbitrairement U,D,R aux valeurs choisies dans le excel.
            delete pricer;
            delete opt_ptr;
